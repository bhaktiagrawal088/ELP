...
const CashAsyncErrors_1 = require("./CashAsyncErrors");
const ErrorHandler_1 = __importDefault(require("../utlis/ErrorHandler"));
const jsonwebtoken_1 = __importDefault(require("jsonwebtoken"));
const redis_1 = require("../utlis/redis");
// authenticated user
exports.isAuthenticated = (0, CashAsyncErrors_1.CatchAsyncError)(async (req, res, next) => {
    ...
    if (!decoded) {
        return next(new ErrorHandler_1.default("Access toke is not valid", 400));
    }
